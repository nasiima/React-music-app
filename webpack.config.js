...
const config = {
  entry: [path.resolve(ROOT_DIRECTORY, '/Users/nasiimamohamed/Desktop/auguste/coursework/week_8/music-app/src/index.js')], // the main JavaScript file of the project
  output: {
